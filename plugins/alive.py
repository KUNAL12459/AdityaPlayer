...
@Client.on_message(commandpro(["/vcstart", "/alive",]) & filters.group & ~filters.edited)
...
@Client.on_message(commandpro(["vcrepo", "#vcrepo", "@repo", "/repo", "source"]) & filters.group & ~filters.edited)
